    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-cs-bg/90 backdrop-blur-xl border-b border-cs-border/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
        ...
        <nav className="hidden sm:flex items-center gap-8 text-sm font-body font-medium text-cs-muted">
          ...
          <a href="#grid" className="hover:text-cs-blue transition-colors duration-200">Explorar</a>
          <a href="#grid" className="hover:text-cs-blue transition-colors duration-200">Sobre</a>
        </nav>

        {/* CTA */}
        <a
          href="#grid"
          className="text-xs font-body font-bold uppercase tracking-wider px-4 py-2 rounded-lg bg-gradient-to-r from-cs-blue to-cs-gold text-white hover:shadow-lg hover:shadow-cs-blue/50 transition-all duration-200 transform hover:scale-105"
        >
          Explorar
        </a>
      </div>
